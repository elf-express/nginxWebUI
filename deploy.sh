...
cp deploy/promtail-config.yml "$INSTALL_DIR/"
cp deploy/grafana-datasources.yml "$INSTALL_DIR/"
cp deploy/grafana-dashboards.yml "$INSTALL_DIR/"
cp deploy/grafana-nginx-dashboard.json "$INSTALL_DIR/"
