...
> Source: https://nginx.org/en/docs/stream/ngx_stream_proxy_protocol_vendor_module.html

---

## 目錄

- [Module ngx\_stream\_proxy\_protocol\_vendor\_module](#module-ngxstreamproxyprotocolvendormodule)
    - [Example Configuration](#example-configuration)
    - [Embedded Variables](#embedded-variables)

---

## Module ngx\_stream\_proxy\_protocol\_vendor\_module

`ngx_stream_proxy_protocol_vendor_module`模塊（1.23.3）允許從[PROXY protocol](http://www.haproxy.org/download/1.8/doc/proxy-protocol.txt)標頭的應用程式特定TLV獲取有關雲平台中連接的附加信息。
...
必須通過在[listen](https://nginx.org/en/docs/stream/ngx_stream_core_module.html#listen)指令中設置`proxy_protocol`參數來預先啟用PROXY協議。
